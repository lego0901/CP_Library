...
#ifndef LINE_CONTAINER_MIN_DEFINED
...
struct line_ll {
	...
	bool operator<(const line_ll &o) const { return a > o.a; }
	bool operator<=(const line_ll &o) const { return a >= o.a; }
...
#define LINE_CONTAINER_MIN_DEFINED
//////// ---- Woosung Song's Source Code ---- ////////


int main() {
	int m; cin >> m;
	line_container_min lc;
	while (m--) {
		ll t, a, b;
		cin >> t;
		if (t == 1) {
